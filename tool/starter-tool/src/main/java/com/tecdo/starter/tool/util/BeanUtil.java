...
import com.tecdo.starter.tool.beans.BeanProperty;
import com.tecdo.starter.tool.beans.PacBeanCopier;
import com.tecdo.starter.tool.beans.PacBeanMap;
import com.tecdo.starter.tool.convert.PacConverter;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T copy(@Nullable Object source, Class sourceClazz, Class<T> targetClazz) {
		...
		PacBeanCopier copier = PacBeanCopier.create(sourceClazz, targetClazz, false);
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		...
		PacBeanCopier copier = PacBeanCopier
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		PacBeanCopier copier = PacBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new PacConverter(sourceClazz, targetClazz));
		return to;
	}

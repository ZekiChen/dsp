 ...
 **/
public abstract class PacBeanCopier {
	private static final Type CONVERTER = TypeUtils.parseType("org.springframework.cglib.core.Converter");
	private static final Type BEAN_COPIER = TypeUtils.parseType(PacBeanCopier.class.getName());
	...
	/**
	 * The map to store {@link PacBeanCopier} of source type and class type for copy.
	 */
	private static final ConcurrentMap<PacBeanCopierKey, PacBeanCopier> BEAN_COPIER_MAP = new ConcurrentHashMap<>();

	public static PacBeanCopier create(Class source, Class target, boolean useConverter) {
		return PacBeanCopier.create(source, target, useConverter, false);
	}

	public static PacBeanCopier create(Class source, Class target, boolean useConverter, boolean nonNull) {
		PacBeanCopierKey copierKey = new PacBeanCopierKey(source, target, useConverter, nonNull);
	...
	public static class Generator extends AbstractClassGenerator {
		private static final Source SOURCE = new Source(PacBeanCopier.class.getName());
		...
		@Override
		public PacBeanCopier create(Object key) {
			return (PacBeanCopier) super.create(key);
		}

...
public interface ClickJobCurRecordMapper extends BaseMapper<ClickJobCurRecord> {
  ...
  Long getCur(String country, String os, String packageName, Integer recallType);
  ...
  void createCur(String country, String os, String packageName, Integer recallType, Long offset);

  @Update(
    "update click_job_cur_record set cur = #{offset} where country = #{country} and os = #{os} and package_name = #{packageName}" +
    "and recall_type = #{recallType}")
  void updateCur(String country, String os, String packageName, Integer recallType, Long offset);

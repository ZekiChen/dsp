...
public class ResponseLogger {
  ...
  private static ResponseLog buildResponseLog(AdDTOWrapper wrapper,
    ...
    return ResponseLog.builder()
                      ...
                      .tagId(imp.getTagid())
                      .lazadaRtaRequest(wrapper.getLazadaRtaRequest())
                      .lazadaRtaRequestTrue(wrapper.getLazadaRtaRequestTrue())
                      .aeRtaRequest(wrapper.getAeRtaRequest())
                      .aeRtaRequestTrue(wrapper.getAeRtaRequestTrue())

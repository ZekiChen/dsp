...
public abstract class LazopUtils {
   ...
   */
  public static String signApiRequest(RequestContext requestContext,
                                      String appSecret,
                                      String signMethod) throws IOException {
    return signApiRequest(requestContext.getApiName(),
                          requestContext.getAllParams(),
                          null,
                          appSecret,
                          signMethod);
  }
   ...
   */
  public static String signApiRequest(String apiName,
  ...
  private static byte[] encryptHMACSHA256(String data, String secret) throws IOException {
    ...
    try {
      SecretKey secretKey = new SecretKeySpec(secret.getBytes(Constants.CHARSET_UTF8),
                                              Constants.SIGN_METHOD_HMAC_SHA256);

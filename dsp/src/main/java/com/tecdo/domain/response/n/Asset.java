...
import com.tecdo.domain.request.n.Data;

import lombok.Getter;
import lombok.Setter;

/**
 * @see com.tecdo.domain.request.n.Asset 的响应
...
public class Asset extends Extension {
  ...
  /**
   * 唯一的id，必须和{@link com.tecdo.domain.request.n.Asset#id}对应
   */
  private Integer id;

  /**
   * 设置为1，如果Asset是被要求必须返回响应的，可以设置为 {@link com.tecdo.domain.request.n.Asset#required}的值
   */

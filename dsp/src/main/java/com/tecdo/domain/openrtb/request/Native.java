...
import com.tecdo.enums.openrtb.APIFrameworkEnum;
import com.tecdo.enums.openrtb.CreativeAttributeEnum;
...
public class Native extends Extension {
     ...
     * 在1.1版本之前为{@link NativeRequestWrapper}的json字符串
     * 在1.1版本机之后为{@link NativeRequest}的json字符串
     */
